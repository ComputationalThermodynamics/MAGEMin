...
function convertBulk4MAGEMin(   bulk_in     :: T1,
    ...
    oxide_config = Dict(
        ...
        "igd" => (core=["SiO2", "Al2O3", "CaO", "MgO", "FeO", "K2O", "Na2O"],
