...
function convertBulk4MAGEMin(   bulk_in     :: T1,
    ...
    elseif db == "ume"
        c = findall( MAGEMin_ox .!= "S" .&& MAGEMin_ox .!= "O" .&& MAGEMin_ox .!= "Cr2O3" .&& MAGEMin_ox .!= "H2O");
        d = findall( MAGEMin_ox .== "S" .|| MAGEMin_ox .== "O" .&& MAGEMin_ox .!= "Cr2O3" );
    elseif db == "mpe"
